const cardsData = [
  ...
  },
  {
    ...
    date: 'Aug 28, 2025',
    message: 'Riktigt snygg webbsida!',
    postedOn: 'robertonebygg'
  },
  {
    image:
    ...
    link: 'www.google.com',
    message: 'Test data!',
    svg: '<path d="m.027 0 4.247 5.516L0 10h.962l3.742-3.926L7.727 10H11L6.514 4.174 10.492 0H9.53L6.084 3.616 3.3 0zM1.44.688h1.504l6.64 8.624H8.082z" fill="currentColor"/>'
  }
]
...
const createCard = (card) => `
        <div class="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
            <div class="flex gap-2">
                <img class="size-11 rounded-full" src="${
                  card.image || 'images/omdome_user.png'
                }" alt="User Image">
                <div class="flex flex-col ${
                  !card.handle ? 'justify-center' : ''
                }">
            ...
            <div class="flex items-center justify-between text-slate-500 text-xs">
                <div class="flex items-center gap-1">
                    <span>Publicerad på ${card.postedOn || ' '}</span>
                    <a href="${
                      card.link || '#'
                    }" target="_blank" class="hover:text-sky-500">
